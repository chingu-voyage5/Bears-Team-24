...
describe('creating tree', () => {
  ...
  const articles = [
    ...
    { _id: '2', topic : 'Voyage', sub_topic : 'About this wiki', title : 'How to Contribute'},
    { _id: '3', topic : 'Voyage', sub_topic : 'About Voyages', title : 'About Voyages'},
  ];
  const expectedTree = {
    Voyage: {
  ...
  const expectedElements = ([
    <Collapsible key="Voyage" title="Voyage">
      <Collapsible key="About this wiki" title="About this wiki">
        <Link key="Home" to={'/cms/1'}>Home</Link>
        <Link key="How to Contribute" to={'/cms/2'}>How to Contribute</Link>
      </Collapsible>
      <Collapsible key="About Voyages" title="About Voyages" >
        <Link key="About Voyages" to={'/cms/3'}>About Voyages</Link>
      </Collapsible>
    </Collapsible>
  ]);
